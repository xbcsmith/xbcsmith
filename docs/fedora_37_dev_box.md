...
export GOARCH=amd64
export GOOS=linux
export GO_CHECKSUM=105889992ee4b1d40c7c108555222ca70ae43fccb42e20fbf1eebb822f5e72c6
...
echo 'P0l4r1s_!' | sudo passwd ${NEW_USER} --stdin
```
...
for U in $USERS;do
  ...
  echo 'ChangeME!' | sudo passwd ${U} --stdin
done
```
